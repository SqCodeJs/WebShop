...
import { AuthenticatedUser } from '../../../../shared/types/commonTypes';
import { Dispatch } from 'redux';
import { fetchPost } from '../../helpers/functions';

export const setCurrentUser = (user: AuthenticatedUser): AccountAction => ({
...
const handleAuthResponse = (
    res: AxiosResponse<AuthenticatedUser>,
    dispatch: Dispatch<AccountAction | MessageAction>,
): void => {
...
export function loginAction(data: { mail: string; password: string }) {
    return async (
        ...
        try {
            ...
            const typedRes = response as AxiosResponse<AuthenticatedUser>;
...
export function removeUserAction(data: { id: number }) {
    return async (
        ...
        try {
            ...
            const responseError = (error as any).message;
